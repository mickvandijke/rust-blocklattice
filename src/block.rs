...
impl Block {
    pub fn new (height: Height, account: &str, block_type: BlockType, previous_hash: &str, timestamp: Timestamp, target: &str, amount: u64) -> Self {
        Block {
            height,
            block_type,
    ...
    pub fn new_receive (height: Height, account: &str, previous_hash: &str, timestamp: Timestamp, target_block: &str, amount: u64) -> Self {
        Block::new(height, account, BlockType::Receive, previous_hash, timestamp, target_block, amount)
    }
    ...
    pub fn calculate_hash (&self) -> String {
        ...
        hashable_string.push_str(&self.target.to_string());
